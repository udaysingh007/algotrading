...
class IBApi(EWrapper,EClient):
    ...
    ###################################################
    def error(self, id, errorCode, errorMsg, tempVar):
        print(errorCode)
        print(errorMsg)
...
class Bot:
    ...
    def __init__(self):
        ...
        #self.ib.reqHistoricalData(0,contract,"","2 D",str(self.barsize)+mintext,"TRADES",1,1,True,[])
        self.ib.reqMktData(1000, contract, "", False, False, [])
